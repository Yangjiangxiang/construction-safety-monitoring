...
from project_yolov7det.utils.google_utils import attempt_download
...
def attempt_load(weights, map_location=None):
    # Module NOt Foulder:model.yolo改进
    yolov7_folder_dir = str(Path(__file__).parents[1].absolute())  # or models folder path
    try:
        ...
        for w in weights if isinstance(weights, list) else [weights]:
            attempt_download(w)
            # 这里不知道为什么 一直报错ModuleNotFoundError: No module named 'models.yolo'
